...
app.config(function($routeProvider) {
    		...
    		.when("/responseReport", {
        		templateUrl : "respRepo.html",
        		controller: "respRepoController"
    		})
    		...
    		.when("/report1", {
    			...
    			templateUrl : "customDirective211.html",
    			controller:"MyCtrl2"
    		})
    		.when("/menu", {
    			resolve:{
        		...
        		templateUrl : "index7CDirLogin1.html",
    		...
    		.when("/addAdminUser", {
        		...
        		templateUrl : "addAdminUser1.html",
    		...
    		.when("/deleteAdminUser", {
        		...
        		templateUrl : "deleteAdminUser1.html",
    		...
    		.when("/changePassword", {
        		...
        		templateUrl : "changePassword1.html",
...
//	    
//	    $http({
//			url:"http://localhost:8080/AngularCDWLUserMngnt2WithCSS/DeleteAdminUserServlet",
//			method:"GET",
//			params:{
//				"userName":item,
//			}
...
//	});
	...
	$http({
		url:"http://localhost:8080/AngularCDWLUserMngnt2WithCSS/AngularJsServlet3",
		method:"GET",
	}).then(function(response){
...
app.controller('changePasswordController',['$cookies','$window','$http','$scope','$location',function($cookies,$window,$http,$scope,$location){
	...
	$scope.updatePasswordFunction=function(){
		...
		$http({
			url:"http://localhost:8080/AngularCDWLUserMngnt2WithCSS/UpdatePasswordServlet",
			method:"GET",
			params:{
...
app.controller('addAdminUserController',['$cookies','$window','$http','$scope','$location',function($cookies,$window,$http,$scope,$location){
	...
	$scope.addAdminUserFunction=function(){
		...
		$http({
			url:"http://localhost:8080/AngularCDWLUserMngnt2WithCSS/AddAdminUserServlet",
			method:"GET",
			params:{
				"userName":uname,   //$scope.username,
				"passWord":pass,      //$scope.password
...
app.controller('loginControllerForAdminAndUSer',['$cookies','$window','$http','$scope','$location',function($cookies,$window,$http,$scope,$location){
	...
	$scope.submit=function(){
		...
		$http({
			url:"http://localhost:8080/AngularCDWLUserMngnt2WithCSS/AdminUserLoginServlet",
			method:"GET",
			params:{
				"userName":uname,   //$scope.username,
				"passWord":pass      //$scope.password
...
app.controller('myCtrl',['$cookies','$scope','$window','$http',function($cookies,$scope,$window,$http){  // $scope , $window , $http
	...
	$scope.dataArrayList=function(){
				...
				$http({
					url:"http://localhost:8080/AngularCDWLUserMngnt2WithCSS/AngularJsServlet1",
					method:"GET",
					params:{
...
app.controller('myCtrl1',['$cookies','$scope','$window','$http',function($cookies,$scope,$window,$http){  // $scope , $window , $http
	...
	$scope.startBtn=function(){
		$http({
			url:"http://localhost:8080/AngularCDWLUserMngnt2WithCSS/StartFetchingData",
			method:"GET",
		}).then(function(response){
					$scope.statusCode=response.status;
			},function(response){
	...
	$scope.stopBtn=function(){
		$http({
			url:"http://localhost:8080/AngularCDWLUserMngnt2WithCSS/StopFetchingData",
			method:"GET",
			}).then(function(response){
					$scope.statusCode=response.status;
			},function(response){
...
app.controller('MyCtrl2',['$cookies','$scope','$window','$http',function($cookies,$scope,$window,$http){  
	...
	$scope.getRangeAndData=function(){
		...
		$http({
			url:"http://localhost:8080/AngularCDWLUserMngnt2WithCSS/AngularJsServlet1",
			   //http://localhost:8080/AngularCDWLUserMngnt2WithCSS/AngularJsServlet1
			method:"GET",
			params:{
...
app.directive('mydirc1',['$http','$window',function($http,$window) {
...
app.controller('respRepoController',['$cookies','$scope','$window','$http',function($cookies,$scope,$window,$http){  
	
	$scope.getResponseRangeAndData=function(){
		...
		$http({
			url:"http://localhost:8080/AngularCDWLUserMngnt2WithCSS/AngularJsServlet11",
			   //http://localhost:8080/AngularCDWLUserMngnt2WithCSS/AngularJsServlet11
			method:"GET",
			params:{
				"startRange":$scope.data11,   //$scope.startRange,
				"endRange":$scope.data22     //$scope.endRange
...
//			console.log(JSONData);
			...
			for (i = 0; i <$scope.JSONData.length; i++) {
				// Inserting values to Array
				$scope.respTime.push($scope.JSONData[i].map.responseTime);
				$scope.readDTData.push($scope.JSONData[i].map.readingDateAndTime);
			}
		},function(response){
			$window.alert("Connection Failed");
		});
...
app.controller('AddURLController',['$cookies','$scope','$window','$http',function($cookies,$scope,$window,$http){  
	
	$scope.addUrlFunction=function(){
		$scope.data11=$('#getUrlField').val();
		$http({
			url:"http://localhost:8080/AngularCDWLUserMngnt2WithCSS/StoreUrlServlet",
			   //http://localhost:8080/AngularCDWLUserMngnt2WithCSS/StoreUrlServlet
			method:"GET",
			params:{
				"getUrl":$scope.data11
			}
